...
export function getMockPipelineLeads(): PipelineLead[] {
  return [
    { id: "1", name: "Dr. Amit Verma",   phone: "9876543211", equipment: "Dental Chair",    source: "Website",    city: "Delhi",     status: "new",                failedAttempts: 0, createdAt: new Date(Date.now() - 1000 * 60 * 60 * 2),                                                                value: "₹2.5L" },
    { id: "2", name: "Dr. Neha Gupta",   phone: "9123456780", equipment: "X-Ray Unit",       source: "Trade Show", city: "Mumbai",    status: "contacted",          failedAttempts: 5, createdAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 2), lastAttemptTime: new Date(Date.now() - 1000 * 60 * 30), value: "₹4.2L" },
    { id: "3", name: "Dr. Vikram Singh", phone: "9567891235", equipment: "Autoclave",        source: "Referral",   city: "Bangalore", status: "qualified",          failedAttempts: 1, createdAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 5),                                                          value: "₹85K"  },
    { id: "4", name: "Dr. Sunita Reddy", phone: "9432198766", equipment: "Imaging System",   source: "Google Ads", city: "Hyderabad", status: "meeting-scheduled",  failedAttempts: 0, createdAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 7),                                                          value: "₹8.5L" },
    { id: "5", name: "Dr. Manoj Tiwari", phone: "9876123451", equipment: "Compressor",       source: "Cold Call",  city: "Chennai",   status: "new",                failedAttempts: 2, createdAt: new Date(Date.now() - 1000 * 60 * 60 * 4),                                                                value: "₹45K"  },
    { id: "6", name: "Dr. Priya Kapoor", phone: "9988776655", equipment: "Light Cure",       source: "Website",    city: "Pune",      status: "contacted",          failedAttempts: 1, createdAt: new Date(Date.now() - 1000 * 60 * 60 * 8),                                                                value: "₹32K"  },
    { id: "7", name: "Dr. Rohit Sharma", phone: "9112233445", equipment: "Handpiece",        source: "Referral",   city: "Jaipur",    status: "new",                failedAttempts: 0, createdAt: new Date(Date.now() - 1000 * 60 * 30),                                                                     value: "₹18K"  },
  ]
}

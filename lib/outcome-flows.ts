...
export const OUTCOME_FLOWS: Record<string, OutcomeFlow> = {
  "engaged-ready": {
    ...
    outcome: "engaged",
    subState: "ready",
    title: "Engaged — book the physical meeting now",
    whatThisDoes: "Schedules the physical meeting, hands the lead to a named salesperson, and logs the call — all in the same step.",
    guidedAction: "open-meeting-modal",
    mandatoryBeforeCommit: true,
    requiresQualification: true,
    predictedClose: "required",
    thresholds: [
      "Physical-meeting details are required before the call logs",
      "Hands the lead to a named salesperson in the SAME step (6h summary / 12h quote SLAs start)",
      "SAP ownership reassigned; the lead exits any active drip",
    ],
    nodes: [
      n("s", "fe", "start", "Engaged · “Ready — physical meeting”"),
      n("f-fields", "fe", "fe-action", "Capture physical-meeting details (mandatory)", { detail: "date, location, salesperson, address" }),
      n("a-meeting", "fe", "api", "Book physical meeting + handover"),
    ...
    edges: [
      e("s", "f-fields"), e("f-fields", "a-meeting"),
      e("a-meeting", "b-physical"), e("a-meeting", "a-attempt", "then"), e("a-attempt", "b-attempt"),
      e("b-physical", "t-quote"), e("t-quote", "t-close"),
    ],
  },
  ...
  "engaged-nurture": {
    ...
    outcome: "engaged",
    subState: "nurture",
    title: "Engaged — nurture (Zoom or drip)",
    whatThisDoes: "Opens Qualification to confirm the lead, then routes by your choice: a Zoom consult (design-fee branch) or the nurture drip on the timeline track.",
    guidedAction: "enter-drip",
    mandatoryBeforeCommit: false,
    requiresQualification: true,
    predictedClose: "required",
    thresholds: [
      "Qualification opens first — pick Zoom consult or Add to Drip under ‘Next Step Route’",
      "Zoom → books a Zoom meeting (design-fee branch) and logs the call together",
      "Drip → 1-month = 9 touches/17d · 3-month = 19/90d · 6-month = 13/168d; a reply/meeting exits it",
    ],
    nodes: [
      n("s", "fe", "start", "Engaged · “Not ready — nurture”"),
      n("f-qual", "fe", "fe-action", "Qualification — choose route", { detail: "Next Step Route: Zoom consult | Add to Drip" }),
      n("f-dec", "fe", "decision", "Zoom or Drip?"),
      n("a-zoom", "fe", "api", "Book Zoom + log engaged", { detail: "Zoom modal · design-fee branch" }),
      n("a-attempt", "fe", "api", "Log engaged + enter drip"),
    ...
    edges: [
      e("s", "f-qual"), e("f-qual", "f-dec"),
      e("f-dec", "a-zoom", "zoom"), e("f-dec", "a-attempt", "drip"),
      e("a-zoom", "b-zoom"), e("b-zoom", "t-quote"), e("t-quote", "t-close"),
      e("a-attempt", "b-drip"), e("b-drip", "b-engine"), e("b-engine", "t-exit"),
    ],
  },
